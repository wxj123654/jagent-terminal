...
render(<GitGraphView cwd={repoDir} store={store} repoLabel="bench-repo" />, { renderer })
...
if (!ok) {
  console.error(JSON.stringify({ error: 'repo did not load', state: store.getState().status }))
  process.exit(1)
}
